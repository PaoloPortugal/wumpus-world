...
-- makes an empty map
	...
	world[1][1].tile=0
	world[1][1].came_from=2 -- itll look like the player entered from above
...
-- tries to move the player in a certain direction, or makes them look in that direction
	...
	if new_i~=player.i or new_j~=player.j then
		...
		if world[new_i] and world[new_i][new_j] and world[new_i][new_j].tile~=nil then
			player.last_i=player.i
			player.last_j=player.j
			player.i=new_i
			player.j=new_j
...
-- makes the cell the player stepped into visible
	...
	if world[i][j].came_from==nil then
		...
		elseif player.last_i>player.i then -- came from right
			world[i][j].came_from=1
		elseif player.last_j<player.j then -- came from up
			world[i][j].came_from=2
		else -- player.last_j>player.j, came from down
...
-- game visuals
	...
	-- BOX 1
	local txt1 = "aRROWS LEFT: "..player.arrows
	rectfill(0, base_y, #txt1*4 + 4, base_y+8, 0)
	print(txt1, 2, base_y+2, 7)
	base_y += 10

	-- BOX 2
	local txt2 = "gOLD LEFT TO COLLECT:"..world.gold_amount
	rectfill(0, base_y, #txt2*4 + 4, base_y+8, 0)
...
-- logic for rendering each individual tile
	...
	if cell.tile==nil then
		...
		elseif cell.tile==-2 then
			...
			if tile_sprite==1 and cell.came_from~=nil then
				tile_sprite=40+cell.came_from
			end
		end
	end
...
function draw_main_menu()
    ...
    local title_x = 64 - (#title*4)/2 -- center it properly
    print(title, title_x, 10, 7)
    -- menu items
    local menu_y = 50
    for i, item in ipairs(main_menu_items) do
        local text_x = 64 - (#item.text*4)/2 -- center it properly
        local color = (menu_index == i) and 8 or 7
        print(item.text, text_x, menu_y, color)
        menu_y += 10
    end
    print("🅾️ (z) TO CONFIRM", 4, 96, 7)
    print("⬆️⬇️ TO SELECT", 4, 104, 7)
end
...
function draw_options_menu()
    ...
    print("❎ TO GO BACK, ⬅️ ➡️ TO ADJUST", 8, 96, 7)
end
...
function draw_instructions_menu()
    ...
    y += 8
	y = print_wrapped("cHANGE THE DIRECTION YOU ARE FACING BY PRESSING DOWN ❎ AND AN ARROW KEY, THEN SHOOT AT A wUMPUS WITH 🅾️ (z) TO KILL IT! (TIP: yOU WILL GET ROUGHLY ONE FOURTH MORE ARROWS THAN THE AMOUNT OF wUMPUSES IN THE MAP!)", 4, y, 7)
    y += 8
...

...

...

